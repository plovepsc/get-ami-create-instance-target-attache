...
result = subprocess.run(["terraform", "output", "running_instance_id"], capture_output=True, text=True)

# Extract the output value from the result
output_value = result.stdout.strip()

# Write the output value to a text file
with open("/home/ubuntus/terarom/get-ami/create-instance-amis/terraform.tfvars", "w") as file:
